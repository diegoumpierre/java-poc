...
public class KafkaConfig {
    ...
    public NewTopic emailQueueTopic() {
        return TopicBuilder.name(emailQueueTopic)
                .partitions(3)
                .replicas(1)
                .build();
    }
    ...
    @Bean
    public NewTopic outboundQueueTopic() {
        return TopicBuilder.name(outboundQueueTopic)
                .partitions(3)
                .replicas(1)
                .build();
    }
    ...
    @Bean
    public NewTopic inboundEventsTopic() {
        return TopicBuilder.name(inboundEventsTopic)
                .partitions(3)
                .replicas(1)
                .build();
    }
