...
class Game {
    private int exterminatorAmount = 0;
    private int mosquitoAlive = 0;
    private int mosquitoKilled = 0;
    private Object[][] grid;

    public Game(int row, int column, int mosquito) {
       new Game(row, column, mosquito, 1);
    }

    public Game(int row, int column, int mosquito, int exterminatorAmount) {
        grid = new Object[row][column];
        this.mosquitoAlive = mosquito;
        this.exterminatorAmount = exterminatorAmount;
    }
