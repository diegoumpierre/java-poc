...
import br.dev.guereguere.dto.DataTableFilterMetaDTO;
...
@AllArgsConstructor
@NoArgsConstructor
public class PessoaRequestPesquisaDTO implements Serializable {

    private static final long serialVersionUID = 1L;

    private PesquisaDTO pesquisaDTO;

    private DataTableFilterMetaDTO filters;
}
