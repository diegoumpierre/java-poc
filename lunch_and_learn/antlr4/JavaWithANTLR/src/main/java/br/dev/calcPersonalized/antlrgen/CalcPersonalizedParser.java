...
public class CalcPersonalizedParser extends Parser {
    ...
    public static class ProgContext extends ParserRuleContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalcPersonalizedVisitor)
                return ((CalcPersonalizedVisitor<? extends T>) visitor).visitProg(this);
    ...
    public static class ExprOnlyContext extends StatContext {
        ...
        public ExprOnlyContext(StatContext ctx) {
            copyFrom(ctx);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalcPersonalizedVisitor)
                return ((CalcPersonalizedVisitor<? extends T>) visitor).visitExprOnly(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AssignContext extends StatContext {
        public TerminalNode ID() {
            return getToken(CalcPersonalizedParser.ID, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalcPersonalizedVisitor)
                return ((CalcPersonalizedVisitor<? extends T>) visitor).visitAssign(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class MulExprContext extends ExprContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalcPersonalizedVisitor)
                return ((CalcPersonalizedVisitor<? extends T>) visitor).visitMulExpr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class VarExprContext extends ExprContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalcPersonalizedVisitor)
                return ((CalcPersonalizedVisitor<? extends T>) visitor).visitVarExpr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class AddExprContext extends ExprContext {
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalcPersonalizedVisitor)
                return ((CalcPersonalizedVisitor<? extends T>) visitor).visitAddExpr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class IntExprContext extends ExprContext {
        public TerminalNode INT() {
            return getToken(CalcPersonalizedParser.INT, 0);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalcPersonalizedVisitor)
                return ((CalcPersonalizedVisitor<? extends T>) visitor).visitIntExpr(this);
            else return visitor.visitChildren(this);
        }
    }
    ...
    public static class ParenExprContext extends ExprContext {
        ...
        @Override
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CalcPersonalizedListener)
                ((CalcPersonalizedListener) listener).enterParenExpr(this);
        }
        ...
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof CalcPersonalizedVisitor)
                return ((CalcPersonalizedVisitor<? extends T>) visitor).visitParenExpr(this);
            else return visitor.visitChildren(this);
        }
    }
